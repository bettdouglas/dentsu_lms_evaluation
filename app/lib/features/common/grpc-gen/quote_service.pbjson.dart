...
final $typed_data.Uint8List listQuotesRequestDescriptor = $convert.base64Decode(
    'ChFMaXN0UXVvdGVzUmVxdWVzdBIWCgZwYXJlbnQYASABKAlSBnBhcmVudBIbCglwYWdlX3NpemUYAiABKAVSCHBhZ2VTaXplEh0KCnBhZ2VfdG9rZW4YAyABKAlSCXBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List listQuotesResponseDescriptor = $convert.base64Decode(
    'ChJMaXN0UXVvdGVzUmVzcG9uc2USIgoGcXVvdGVzGAEgAygLMgoubG1zLlF1b3RlUgZxdW90ZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List getQuoteRequestDescriptor =
    $convert.base64Decode('Cg9HZXRRdW90ZVJlcXVlc3QSDgoCaWQYASABKAVSAmlk');
...
final $typed_data.Uint8List createQuoteRequestDescriptor = $convert.base64Decode(
    'ChJDcmVhdGVRdW90ZVJlcXVlc3QSIAoFcXVvdGUYASABKAsyCi5sbXMuUXVvdGVSBXF1b3RlEhcKB2xlYWRfaWQYAiABKAVSBmxlYWRJZA==');
...
final $typed_data.Uint8List updateQuoteRequestDescriptor = $convert.base64Decode(
    'ChJVcGRhdGVRdW90ZVJlcXVlc3QSIAoFcXVvdGUYASABKAsyCi5sbXMuUXVvdGVSBXF1b3RlEjsKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IKdXBkYXRlTWFzaw==');
...
final $typed_data.Uint8List deleteQuoteRequestDescriptor =
    $convert.base64Decode('ChJEZWxldGVRdW90ZVJlcXVlc3QSDgoCaWQYASABKAVSAmlk');
