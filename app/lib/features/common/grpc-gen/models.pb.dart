...
class Lead extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(12)
  set productRequested($core.String v) {
    $_setString(11, v);
  }
...
class QuoteSetup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        protoName: 'numberOfChildrenCovered')
    ..aOS(
        5,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(4)
  set numberOfChildrenCovered($core.String v) {
    $_setString(3, v);
  }
...
class QuoteBenefit extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(11)
  set amrefEvacuation($core.bool v) {
    $_setBool(10, v);
  }
