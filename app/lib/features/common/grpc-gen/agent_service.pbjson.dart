...
final $typed_data.Uint8List listAgentsRequestDescriptor = $convert.base64Decode(
    'ChFMaXN0QWdlbnRzUmVxdWVzdBIbCglwYWdlX3NpemUYASABKAVSCHBhZ2VTaXplEh0KCnBhZ2VfdG9rZW4YAiABKAlSCXBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List listAgentsResponseDescriptor = $convert.base64Decode(
    'ChJMaXN0QWdlbnRzUmVzcG9uc2USIgoGYWdlbnRzGAEgAygLMgoubG1zLkFnZW50UgZhZ2VudHMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List getAgentRequestDescriptor =
    $convert.base64Decode('Cg9HZXRBZ2VudFJlcXVlc3QSDgoCaWQYASABKAVSAmlk');
...
final $typed_data.Uint8List createAgentRequestDescriptor = $convert.base64Decode(
    'ChJDcmVhdGVBZ2VudFJlcXVlc3QSIAoFYWdlbnQYASABKAsyCi5sbXMuQWdlbnRSBWFnZW50EhoKCHBhc3N3b3JkGAIgASgJUghwYXNzd29yZA==');
...
final $typed_data.Uint8List createAgentResponseDescriptor = $convert.base64Decode(
    'ChNDcmVhdGVBZ2VudFJlc3BvbnNlEiAKBWFnZW50GAEgASgLMgoubG1zLkFnZW50UgVhZ2VudBIQCgNqd3QYAiABKAlSA2p3dA==');
...
final $typed_data.Uint8List updateAgentRequestDescriptor = $convert.base64Decode(
    'ChJVcGRhdGVBZ2VudFJlcXVlc3QSIAoFYWdlbnQYASABKAsyCi5sbXMuQWdlbnRSBWFnZW50EjsKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IKdXBkYXRlTWFzaw==');
...
final $typed_data.Uint8List deleteAgentRequestDescriptor =
    $convert.base64Decode('ChJEZWxldGVBZ2VudFJlcXVlc3QSDgoCaWQYASABKAVSAmlk');
...
final $typed_data.Uint8List loginResponseDescriptor = $convert.base64Decode(
    'Cg1Mb2dpblJlc3BvbnNlEiEKDGFjY2Vzc190b2tlbhgBIAEoCVILYWNjZXNzVG9rZW4SIwoNcmVmcmVzaF90b2tlbhgCIAEoCVIMcmVmcmVzaFRva2Vu');
...
final $typed_data.Uint8List getAgentFromTokenRequestDescriptor =
    $convert.base64Decode('ChhHZXRBZ2VudEZyb21Ub2tlblJlcXVlc3Q=');
...
final $typed_data.Uint8List getAgentFromTokenResponseDescriptor =
    $convert.base64Decode(
        'ChlHZXRBZ2VudEZyb21Ub2tlblJlc3BvbnNlEiAKBWFnZW50GAEgASgLMgoubG1zLkFnZW50UgVhZ2VudA==');
