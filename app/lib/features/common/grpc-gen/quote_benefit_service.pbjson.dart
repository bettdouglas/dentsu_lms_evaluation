...
final $typed_data.Uint8List listQuoteBenefitsRequestDescriptor =
    $convert.base64Decode(
        'ChhMaXN0UXVvdGVCZW5lZml0c1JlcXVlc3QSFgoGcGFyZW50GAEgASgJUgZwYXJlbnQSGwoJcGFnZV9zaXplGAIgASgFUghwYWdlU2l6ZRIdCgpwYWdlX3Rva2VuGAMgASgJUglwYWdlVG9rZW4=');
...
final $typed_data.Uint8List listQuoteBenefitsResponseDescriptor =
    $convert.base64Decode(
        'ChlMaXN0UXVvdGVCZW5lZml0c1Jlc3BvbnNlEjgKDnF1b3RlX2JlbmVmaXRzGAEgAygLMhEubG1zLlF1b3RlQmVuZWZpdFINcXVvdGVCZW5lZml0cxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List getQuoteBenefitRequestDescriptor = $convert
    .base64Decode('ChZHZXRRdW90ZUJlbmVmaXRSZXF1ZXN0Eg4KAmlkGAEgASgFUgJpZA==');
...
final $typed_data.Uint8List createQuoteBenefitRequestDescriptor =
    $convert.base64Decode(
        'ChlDcmVhdGVRdW90ZUJlbmVmaXRSZXF1ZXN0EjYKDXF1b3RlX2JlbmVmaXQYASABKAsyES5sbXMuUXVvdGVCZW5lZml0UgxxdW90ZUJlbmVmaXQ=');
...
final $typed_data.Uint8List updateQuoteBenefitRequestDescriptor =
    $convert.base64Decode(
        'ChlVcGRhdGVRdW90ZUJlbmVmaXRSZXF1ZXN0EjYKDXF1b3RlX2JlbmVmaXQYASABKAsyES5sbXMuUXVvdGVCZW5lZml0UgxxdW90ZUJlbmVmaXQSOwoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrUgp1cGRhdGVNYXNr');
...
final $typed_data.Uint8List deleteQuoteBenefitRequestDescriptor =
    $convert.base64Decode(
        'ChlEZWxldGVRdW90ZUJlbmVmaXRSZXF1ZXN0Eg4KAmlkGAEgASgFUgJpZA==');
