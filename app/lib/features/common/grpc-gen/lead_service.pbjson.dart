...
final $typed_data.Uint8List listLeadsRequestDescriptor = $convert.base64Decode(
    'ChBMaXN0TGVhZHNSZXF1ZXN0EhsKCXBhZ2Vfc2l6ZRgBIAEoBVIIcGFnZVNpemUSHQoKcGFnZV90b2tlbhgCIAEoCVIJcGFnZVRva2Vu');
...
final $typed_data.Uint8List listLeadsResponseDescriptor = $convert.base64Decode(
    'ChFMaXN0TGVhZHNSZXNwb25zZRIfCgVsZWFkcxgBIAMoCzIJLmxtcy5MZWFkUgVsZWFkcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List getLeadRequestDescriptor =
    $convert.base64Decode('Cg5HZXRMZWFkUmVxdWVzdBIOCgJpZBgBIAEoBVICaWQ=');
...
final $typed_data.Uint8List createLeadRequestDescriptor = $convert.base64Decode(
    'ChFDcmVhdGVMZWFkUmVxdWVzdBIdCgRsZWFkGAEgASgLMgkubG1zLkxlYWRSBGxlYWQ=');
...
final $typed_data.Uint8List createLeadResponseDescriptor =
    $convert.base64Decode(
        'ChJDcmVhdGVMZWFkUmVzcG9uc2USHQoEbGVhZBgBIAEoCzIJLmxtcy5MZWFkUgRsZWFk');
...
final $typed_data.Uint8List updateLeadRequestDescriptor = $convert.base64Decode(
    'ChFVcGRhdGVMZWFkUmVxdWVzdBIdCgRsZWFkGAEgASgLMgkubG1zLkxlYWRSBGxlYWQSOwoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrUgp1cGRhdGVNYXNr');
...
final $typed_data.Uint8List deleteLeadRequestDescriptor =
    $convert.base64Decode('ChFEZWxldGVMZWFkUmVxdWVzdBIOCgJpZBgBIAEoBVICaWQ=');
