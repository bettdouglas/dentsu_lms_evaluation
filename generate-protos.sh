...
mkdir -p app/lib/src/common/grpc-gen/

# Generate models only
protoc -I protos/ --dart_out=app/lib/src/common/grpc-gen/ protos/models.proto 

# Generate Well-Known Types
protoc -I protos/ --dart_out=app/lib/src/common/grpc-gen/ google/protobuf/timestamp.proto google/protobuf/field_mask.proto google/protobuf/empty.proto

# Generate models + grpc stubs
protoc -I protos/ --dart_out=grpc:app/lib/src/common/grpc-gen/ protos/agent_service.proto protos/lead_service.proto protos/quote_benefit_service.proto protos/quote_service.proto protos/quote_setup_service.proto
