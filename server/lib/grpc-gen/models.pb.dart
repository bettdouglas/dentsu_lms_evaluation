...
class Agent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Agent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'lms'), createEmptyInstance: create)
...
class Lead extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Lead', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'lms'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id', $pb.PbFieldType.O3)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'email')
  ...
  factory Lead.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Lead.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Lead copyWith(void Function(Lead) updates) => super.copyWith((message) => updates(message as Lead)) as Lead; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static Lead getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Lead>(create);
...
class QuoteSetup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QuoteSetup', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'lms'), createEmptyInstance: create)
  ...
  factory QuoteSetup.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory QuoteSetup.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QuoteSetup copyWith(void Function(QuoteSetup) updates) => super.copyWith((message) => updates(message as QuoteSetup)) as QuoteSetup; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static QuoteSetup getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QuoteSetup>(create);
  static QuoteSetup? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get ageBracket => $_getSZ(0);
  @$pb.TagNumber(1)
  set ageBracket($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set inPatientCoverLimit($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set spouseCovered($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  set coverChildren($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set spouseAgeBracket($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
...
class QuoteBenefit extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QuoteBenefit', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'lms'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inPatient', protoName: 'inPatient')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outPatient', protoName: 'outPatient')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'noCoPayment', protoName: 'noCoPayment')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dental')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optical')
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maternity')
  ...
  factory QuoteBenefit.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory QuoteBenefit.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QuoteBenefit copyWith(void Function(QuoteBenefit) updates) => super.copyWith((message) => updates(message as QuoteBenefit)) as QuoteBenefit; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QuoteBenefit create() => QuoteBenefit._();
  QuoteBenefit createEmptyInstance() => create();
  static $pb.PbList<QuoteBenefit> createRepeated() => $pb.PbList<QuoteBenefit>();
  @$core.pragma('dart2js:noInline')
  static QuoteBenefit getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QuoteBenefit>(create);
  static QuoteBenefit? _defaultInstance;

  @$pb.TagNumber(1)
  $core.bool get inPatient => $_getBF(0);
  @$pb.TagNumber(1)
  set inPatient($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set outPatient($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set noCoPayment($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set dental($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set optical($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set maternity($core.bool v) { $_setBool(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set lastExpense($core.bool v) { $_setBool(6, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set personalAccident($core.bool v) { $_setBool(7, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set covid19Cover($core.bool v) { $_setBool(8, v); }
  @$pb.TagNumber(9)
...
class Quote extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Quote', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'lms'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id', $pb.PbFieldType.O3)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'quoteId')
    ...
    ..aOM<Agent>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceAgent', subBuilder: Agent.create)
    ..aOM<Lead>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lead', subBuilder: Lead.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'businessUnit', protoName: 'businessUnit')
    ..aOM<QuoteSetup>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'setup', subBuilder: QuoteSetup.create)
    ..aOM<QuoteBenefit>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'benefits', subBuilder: QuoteBenefit.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set quoteId($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(5)
  set sourceAgent(Agent v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  set businessUnit($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set setup(QuoteSetup v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set benefits(QuoteBenefit v) { setField(9, v); }
  @$pb.TagNumber(9)
